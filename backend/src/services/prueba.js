...
exports.InsertPrueba = async (body) => {
  try {
    var { fecha, tipo, examen, grupoSanguineo, identificacionAnticuerpo, pesquizajeAnticuerpo, pendiente, activo } = body;
...
exports.UpdatePrueba = async (id, body) => {
  try {
    var { fecha, tipo, examen, grupoSanguineo, identificacionAnticuerpo, pesquizajeAnticuerpo, pendiente, activo } = body;
    const prueba = { fecha, tipo, examen, grupoSanguineo, identificacionAnticuerpo, pesquizajeAnticuerpo, pendiente, activo };
