...
class ComponentSeeClinicHistory extends Component {
	...
	render() {
		...
		} else return <ComponentAddClinicHistory reloadFromServer={this.props.reloadFromServer} parentState={this.props.parentState} roles={this.props.roles} pacientes={this.props.pacientes} historiasclinicas={this.props.historiasclinicas} cambiarIcono={true} paciente={this.props.paciente} permisos={this.props.permisos} />;
	}
}
