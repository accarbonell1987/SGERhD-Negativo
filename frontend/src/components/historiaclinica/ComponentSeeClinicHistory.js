...
class ComponentSeeClinicHistory extends Component {
	...
	clearModalState = () => {
		...
		let nombreyapellidos =
			this.props.paciente.nombre + " " + this.props.paciente.apellidos;
		let cur = {
	...
	render() {
		...
		if (historia != null) {
			let classNameToButton = !historia.activo
				? "button-childs button-disable"
				: "button-childs";
			return (
				<Modal
									...
									<Form.Group>
										<Segment className="modal-segment-expanded">
											...
											<Form.Checkbox
												...
												name="vacunaAntiD"
												labelPosition="left"
												label={historia.vacunaAntiD === true ? "Si" : "No"}
												value={historia.vacunaAntiD}
												readOnly
											/>
										</Segment>
									</Form.Group>
							...
							<Form.Group>
								<Segment className="modal-segment-expanded">
									...
									<Form.Checkbox
										...
										name="activo"
										labelPosition="left"
										label={historia.activo === true ? "Si" : "No"}
										value={historia.activo}
										checked={historia.activo}
									/>
								</Segment>
							</Form.Group>
						</Form>
