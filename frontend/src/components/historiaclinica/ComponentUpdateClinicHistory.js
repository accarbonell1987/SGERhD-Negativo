	...
	ChangeModalState = async (evt) => {
		if (evt.target.className.includes("modal-button-action") || evt.target.className.includes("modal-icon")) {
			...
			this.setState({
				...
				administracionVacuna: this.props.historiaclinica.administracionVacuna,
					...
					<Form ref="form" onSubmit={this.ChangeModalState}>
						...
						<Segment.Group horizontal className="modal-segment-group">
							<Segment className="modal-segment-longleft">
								<Form.Input required name="areaDeSalud" icon="hospital symbol" iconPosition="left" label="Area de Salud:" value={this.state.areaDeSalud} placeholder="Consultorio, Policlinico, Hospital" onChange={this.ChangeModalInput} onKeyDown={this.OnPressEnter} />
							</Segment>
