...
class ComponentApp extends Component {
	...
	render() {
		if (this.state.autenticado) {
			return <ComponentDashboard changeLoginState={this.changeLoginState} parentState={this.state} roles={this.roles} permisos={this.permisos} />;
		} else {
			return <ComponentLogin changeLoginState={this.changeLoginState} parentState={this.state} />;
		}
	}
}
