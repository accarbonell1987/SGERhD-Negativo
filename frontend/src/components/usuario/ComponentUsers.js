								...
								return (
									<Table.Row key={usuario._id} negative={negative}>
										...
										<Table.Cell className="cell-acciones" collapsing>
											...
											{accesomenu.permisos.modificar ? <ComponentUpdateUser reloadFromServer={this.props.reloadFromServer} usuario={usuario} parentState={this.props.parentState} roles={this.props.roles} /> : <Button icon="edit" disabled />}
											{this.props.parentState.rol === "informatico" ? <ComponentChangePassword parentState={this.props.parentState} usuario={usuario} gestion={true} /> : <Button icon="key" disabled />}
										</Table.Cell>
									</Table.Row>
								);
							})}
